class Game {
  ...
  async start() {
    ...
    car1.addAnimation("blueJump", blue_jump)
    car1.scale = 2;
    car2 = createSprite(300, 200);
    car2.addAnimation("redIdle", red_idle);
    car2.addAnimation("redRun", red_run);
    car2.addAnimation("redCrouch", red_crouch);
    car2.addAnimation("redDeath", red_death);
    car2.addAnimation("redJump", red_jump);
    car2.scale = 2;
        ...
        for (var plr in allPlayers[t]) {
          ...
          if (allPlayers[t][plr].life === false) {
            if (allPlayers[t][plr].team === 1) {
              ...
              cars[index - 1].addImage("blueDeathImage", blue_death_image);
            ...
            if (allPlayers[t][plr].team === 2) {
               ...
               //cars[player.index - 1].changeAnimation("redDeath", red_death);

               cars[player.index - 1].addImage("redDeathImage", red_death_image);
